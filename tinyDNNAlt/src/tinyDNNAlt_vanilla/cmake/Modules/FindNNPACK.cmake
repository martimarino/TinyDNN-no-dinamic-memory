...
FIND_LIBRARY(CPUINFO_LIB NAMES cpuinfo PATHS ${NNPACK_LIB_SEARCH_PATHS})
FIND_LIBRARY(CLOG_LIB NAMES clog PATHS ${CLOG_LIB})
...
IF(NOT NNPACK_THREADPOOL_LIB)
    SET(NNPACK_FOUND OFF)
    MESSAGE(STATUS "Could not find NNPACK_THREADPOOL_LIB lib. Turning NNPACK_FOUND off")
ENDIF()

IF(NOT CPUINFO_LIB)
    SET(NNPACK_FOUND OFF)
    MESSAGE(STATUS "Could not find CPUINFO_LIB lib. Turning NNPACK_FOUND off")
ENDIF()

IF(NOT CLOG_LIB)
    SET(NNPACK_FOUND OFF)
    MESSAGE(STATUS "Could not find CLOG_LIB lib. Turning NNPACK_FOUND off")
ENDIF()
