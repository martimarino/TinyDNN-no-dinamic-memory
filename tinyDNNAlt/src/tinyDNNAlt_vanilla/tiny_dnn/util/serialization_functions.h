...
template <>
struct LoadAndConstruct<tiny_dnn::flatten_layer> {
  template <class Archive>
  static void load_and_construct(
    Archive &ar, cereal::construct<tiny_dnn::flatten_layer> &construct) {
    size_t w_,h_,ch_;
    ::detail::arc(ar, ::detail::make_nvp("w_", w_),::detail::make_nvp("h_", h_),::detail::make_nvp("ch_", ch_));
    std::cout << w_ << " " << h_ << " " << ch_ << "\n";
    construct(w_,h_,ch_);
  }
};
...
template <>
struct LoadAndConstruct<tiny_dnn::pseudotanh_layer> {
  template <class Archive>
  static void load_and_construct(
    Archive &ar, cereal::construct<tiny_dnn::pseudotanh_layer> &construct) {
    tiny_dnn::shape3d in_shape;
...
struct serialization_buddy {
  ...
  template <class Archive>
  static inline void serialize(Archive &ar, tiny_dnn::flatten_layer &layer) {
    ::detail::arc(ar, ::detail::make_nvp("w_", layer.w_),::detail::make_nvp("h_", layer.h_),::detail::make_nvp("ch_", layer.ch_));  }  
  ...
  template <class Archive>
  static inline void serialize(Archive &ar, tiny_dnn::pseudotanh_layer &layer) {
    ::detail::arc(ar, ::detail::make_nvp("in_size", layer.in_shape()[0]));
  }
