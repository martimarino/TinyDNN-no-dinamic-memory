...
class OpKernelContext {
 public:
  ...
  void set_in_out(const etl::vector<tensor_t *, MAX_CHANNEL_SIZE> &in_data,
                  etl::vector<tensor_t *, MAX_CHANNEL_SIZE> &out_data) {
    in_data_  = const_cast<etl::vector<tensor_t *, MAX_CHANNEL_SIZE> *>(&in_data);
    out_data_ = &out_data;
  }
  ...
  void set_in_out(const etl::vector<tensor_t *, MAX_CHANNEL_SIZE> &in_data,
    ...
    in_data_  = const_cast<etl::vector<tensor_t *, MAX_CHANNEL_SIZE> *>(&in_data);
    out_data_ = const_cast<etl::vector<tensor_t *, MAX_CHANNEL_SIZE> *>(&out_data);
    out_grad_ = &out_grad;
    in_grad_  = &in_grad;
  }
 ...
 private:
  etl::vector<tensor_t *, MAX_CHANNEL_SIZE> *in_data_;
  etl::vector<tensor_t *, MAX_CHANNEL_SIZE> *out_data_;
  etl::vector<tensor_t *, MAX_CHANNEL_SIZE> *out_grad_;
  etl::vector<tensor_t *, MAX_CHANNEL_SIZE> *in_grad_;
