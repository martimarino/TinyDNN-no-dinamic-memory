...
class max_pooling_layer : public layer {
 public:
  ...
  void back_propagation(const std::vector<tensor_t *, MAX_TENSOR_SIZE> &in_data,
                        const std::vector<tensor_t *, MAX_TENSOR_SIZE> &out_data,
                        std::vector<tensor_t *, MAX_TENSOR_SIZE> &out_grad,
                        std::vector<tensor_t *, MAX_TENSOR_SIZE> &in_grad) override {
