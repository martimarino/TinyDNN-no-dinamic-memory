...
class leaky_relu_layer : public activation_layer {
 public:
   ...
   */
  explicit leaky_relu_layer(const float_t epsilon = float_t(0.01))
   ...
   */
  explicit leaky_relu_layer(size_t in_dim, const float_t epsilon = float_t(0.01))
  ...
  leaky_relu_layer(size_t in_width,
                   size_t in_height,
                   size_t in_channels,
                   const float_t epsilon = float_t(0.01))
