...
#include "tiny_dnn/activations/pseudotanh_layer.h"
...
CEREAL_REGISTER_TYPE(tiny_dnn::pseudotanh_layer)
...
using flatten = tiny_dnn::flatten_layer;
...
using ptanh = tiny_dnn::pseudotanh_layer;
