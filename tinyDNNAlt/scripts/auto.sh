...
make tests_type -j$(nproc)
echo "Done."


train_exe="./example_mnist_train"
test_exe="./example_mnist_test"
p80="_p8_0"
p80tab="_posittab8"
p100="_p10_0"
p10tab="_posittab10"
...
do
	...
	echo "Testing $model with type float32..."
 	$test_exe $model_path ../../data/fashion-mnist > /dev/null
	echo ""
	echo "Testing $model with type posit16,2..."
	$test_exe$p160 $model_path ../../data/fashion-mnist > /dev/null
	echo ""
	echo "Testing $model with type posit14,2"
	$test_exe$p140 $model_path ../../data/fashion-mnist > /dev/null
	echo ""
        echo "Testing $model with type posit12,2"
        $test_exe$p122 $model_path ../../data/fashion-mnist > /dev/null
        echo "" 
	echo "Testing $model with type posit12,0"
	$test_exe$p120 $model_path ../../data/fashion-mnist > /dev/null
	echo ""	
	echo "Testing $model with type posit10,0"
	$test_exe$p100 $model_path ../../data/fashion-mnist > /dev/null
	echo ""
	echo "Testing $model with type posit8,0"
	$test_exe$p80 $model_path ../../data/fashion-mnist  > /dev/null
	echo ""
	echo "Testing $model with type posit10,0 tab"
	$test_exe$p10tab $model_path ../../data/fashion-mnist > /dev/null
	echo ""
	echo "Testing $model with type posit8,0 tab"
	$test_exe$p80tab $model_path ../../data/fashion-mnist  > /dev/null
	mkdir -p ../../plot/$model
	cp ../../plot/* ../../plot/$model
